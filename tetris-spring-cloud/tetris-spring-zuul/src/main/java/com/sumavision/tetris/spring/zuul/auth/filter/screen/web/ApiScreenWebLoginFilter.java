package com.sumavision.tetris.spring.zuul.auth.filter.screen.web;
 ...
 * <b>作者:</b>lzp<br/>
 * <b>版本：</b>1.0<br/>
 * <b>日期：</b>2020年3月18日 下午1:34:26
 */
public class ApiScreenWebLoginFilter extends ZuulFilter{
	private String[] ignores = new String[]{
			"/api/screen/web/auth/do/username/password/login"
		};
		...
		public boolean shouldFilter() {
			...
			String requestUri = request.getRequestURI();
			requestUri = requestUri.replace(new StringBufferWrapper().append("/").append(requestUri.split("/")[1]).toString(), "");
			if(requestUri.startsWith(TerminalType.SCREEN_WEB.getUriPrefix())){
				return true;
			}else{
				return false;
			}
