...
public class CommonTsBO {
	...
	public CommonTsBO(String url,String localIp){
		this.source_ip = CommonUtil.getIpFromUrl(url);
		this.source_port = CommonUtil.getPortFromUrl(url);
		this.local_ip = localIp;
	}

	public CommonTsBO(MediaSourceBO mediaSourceBO){
		this.source_ip = CommonUtil.getIpFromUrl(mediaSourceBO.getUrl());
		this.source_port = CommonUtil.getPortFromUrl(mediaSourceBO.getUrl());
		this.local_ip = mediaSourceBO.getLocalIp();
	}
