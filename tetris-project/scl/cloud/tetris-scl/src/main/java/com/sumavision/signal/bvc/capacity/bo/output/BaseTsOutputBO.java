 ...
 */
public class BaseTsOutputBO<V extends BaseTsOutputBO> implements Serializable {

	private static final long serialVersionUID = 8639430716211932514L;
	...
	public BaseTsOutputBO(String url) {
		this.ip = CommonUtil.getIpFromUrl(url);
		this.port = CommonUtil.getPortFromUrl(url);
	}

	public BaseTsOutputBO(String url, String local_ip) {
		this.ip = CommonUtil.getIpFromUrl(url);
		this.port = CommonUtil.getPortFromUrl(url);
		//切割name
		this.local_ip = local_ip;
