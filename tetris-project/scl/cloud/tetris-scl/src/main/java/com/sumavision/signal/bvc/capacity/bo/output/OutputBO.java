...
public class OutputBO {
	...
	private BaseTsOutputBO udp_ts;
	
	private BaseTsOutputBO rtp_ts;
	...
	public BaseTsOutputBO getUdp_ts() {
		return udp_ts;
	}

	public void setUdp_ts(BaseTsOutputBO udp_ts) {
		this.udp_ts = udp_ts;
	}

	public BaseTsOutputBO getRtp_ts() {
		return rtp_ts;
	}

	public OutputBO setRtp_ts(BaseTsOutputBO rtp_ts) {
		this.rtp_ts = rtp_ts;
		return this;
	}
