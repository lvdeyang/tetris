...
public class PreProcessingBO {
	...
	private AudioGainBO audioGainBO;
	...
	public AudioGainBO getAudioGainBO() {
		return audioGainBO;
	}

	public PreProcessingBO setAudioGainBO(AudioGainBO audioGainBO) {
		this.audioGainBO = audioGainBO;
		return this;
	}
}
