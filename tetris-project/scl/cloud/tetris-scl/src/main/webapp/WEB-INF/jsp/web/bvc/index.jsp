...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath %>web/app/component/bvc2-nav-side/bvc2-nav-side.css">
    <link rel="stylesheet" type="text/css" href="<%=basePath %>web/app/bvc2-signal-control/bvc2-add-repeater/bvc2-add-repeater.css">
    <link rel="stylesheet" type="text/css" href="<%=basePath %>web/app/bvc2-signal-control/bvc2-internet-access/bvc2-internet-access.css">
    <link rel="stylesheet" type="text/css" href="<%=basePath %>web/app/bvc2-signal-control/bvc2-repeater-mapping/bvc2-repeater-mapping.css">
    <link rel="stylesheet" type="text/css" href="<%=basePath %>web/app/bvc2-signal-control/bvc2-terminal-repeater/bvc2-terminal-repeater.css">
    <link rel="stylesheet" type="text/css" href="<%=basePath %>web/app/bvc2-signal-control/bvc2-repeater-task/bvc2-repeater-task.css">
    <link rel="stylesheet" type="text/css" href="<%=basePath %>web/app/bvc2-signal-control/bvc2-task-control/bvc2-task-control.css">
