...
public class MediaCompressCannotMatchException extends BaseException{
	
	private final Logger LOG = LoggerFactory.getLogger(MediaCompressCannotMatchException.class);

	private static final long serialVersionUID = 1L;

	public MediaCompressCannotMatchException(
			String uuid, 
			String pName, 
			long pLastModified,
			long pSize,
