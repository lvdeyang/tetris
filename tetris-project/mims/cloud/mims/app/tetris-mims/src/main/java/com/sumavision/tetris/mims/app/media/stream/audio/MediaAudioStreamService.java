...
public class MediaAudioStreamService {
	 ...
	 * @param Collection<MediaAudioStreamPO> videos 音频流媒资列表
	 */
	public void remove(Collection<MediaAudioStreamPO> videoStreams) throws Exception{
		
		//删除音频流元数据
		mediaAudioStreamDao.deleteInBatch(videoStreams);
