package com.sumavision.tetris.mims.app.media.txt.process;
...
@Controller
@RequestMapping(value = "/api/process/txt")
public class ApiProcessTxtController {
	...
	public Object uploadReviewPassed(
		...
		mediaTxtService.uploadReviewPassed(id);
		return null;
	}
	...
	public Object uploadReviewRefuse(
			Long id,
			HttpServletRequest request) throws Exception{
		mediaTxtService.uploadReviewRefuse(id);
		return null;
	}
	...
	public Object editReviewPassed(
			...
			String content,
			HttpServletRequest request) throws Exception{
		mediaTxtService.editReviewPassed(id, name, tags, keyWords, remark, content);
		return null;
	}
	...
	public Object editReviewRefuse(
			Long id,
			HttpServletRequest request) throws Exception{
		mediaTxtService.editReviewRefuse(id);
		return null;
	}
	...
	public Object deleteReviewPassed(
			Long id,
			HttpServletRequest request) throws Exception{
		mediaTxtService.deleteReviewPassed(id);
		return null;
	}
	...
	public Object deleteReviewRefuse(
			Long id,
			HttpServletRequest request) throws Exception{
		mediaTxtService.deleteReviewRefuse(id);
		return null;
	}
