package com.sumavision.tetris.mims.app.media.stream.audio.process;
...
@Controller
@RequestMapping(value = "/api/process/audio/stream")
public class ApiProcessAudioStreamController {
	...
	public Object uploadReviewPassed(
		...
		mediaAudioStreamService.uploadReviewPassed(id);
		return null;
	}
	...
	public Object uploadReviewRefuse(
			Long id,
			HttpServletRequest request) throws Exception{
		mediaAudioStreamService.uploadReviewRefuse(id);
		return null;
	}
	...
	public Object editReviewPassed(
			...
			String previewUrl,
			HttpServletRequest request) throws Exception{
		mediaAudioStreamService.editReviewPassed(id, name, tags, keyWords, remarks, previewUrl);
		return null;
	}
	...
	public Object editReviewRefuse(
			Long id,
			HttpServletRequest request) throws Exception{
		mediaAudioStreamService.editReviewRefuse(id);
		return null;
	}
	...
	public Object deleteReviewPassed(
			Long id,
			HttpServletRequest request) throws Exception{
		mediaAudioStreamService.deleteReviewPassed(id);
		return null;
	}
	...
	public Object deleteReviewRefuse(
			Long id,
			HttpServletRequest request) throws Exception{
		mediaAudioStreamService.deleteReviewRefuse(id);
		return null;
	}
