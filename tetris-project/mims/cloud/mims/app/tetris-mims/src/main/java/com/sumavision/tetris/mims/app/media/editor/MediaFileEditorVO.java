...
public class MediaFileEditorVO extends AbstractBaseVO<MediaFileEditorVO, MediaFileEditorPO>{
	...
	public MediaFileEditorVO set(MediaFileEditorPO entity) throws Exception {
		...
		return this.setId(entity.getId())
				...
				.setPreviewUrl(entity.getPreviewUrl()==null? null : new StringBufferWrapper().append("http://").append(serverPropsQuery.queryProps().getFtpIp()).append(":").append(serverProps.getPort()).append("/").append(entity.getPreviewUrl()).toString())
