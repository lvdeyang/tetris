...
public class MediaPictureCannotMatchException extends BaseException{
	private final Logger LOG = LoggerFactory.getLogger(MediaPictureCannotMatchException.class);

	private static final long serialVersionUID = 1L;

	public MediaPictureCannotMatchException(
			String uuid, 
			String pName, 
			long pLastModified,
			long pSize,
