 ...
 */
define([
    'text!' + window.APPPATH + 'backstage/process-variable/page-backstage-process-variable.html',
    'config',
    'restfull',
    'context',
    'commons',
    ...
    'element-ui',
    'mi-frame',
    'css!' + window.APPPATH + 'backstage/process-variable/page-backstage-process-variable.css'
], function(tpl, config, ajax, context, commons, Vue){

    var pageId = 'page-backstage-process-variable';
    ...
    var init = function(p){
        ...
        new Vue({
            el: '#' + pageId + '-wrapper',
            data: {
                activeId:'page-backstage-process',
