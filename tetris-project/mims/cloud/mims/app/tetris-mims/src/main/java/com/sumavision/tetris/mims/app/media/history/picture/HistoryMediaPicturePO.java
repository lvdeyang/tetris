package com.sumavision.tetris.mims.app.media.history.picture;
 ...
 */
@Entity
@Table(name = "MIMS_HISTORY_MEDIA_PICTURE")
public class HistoryMediaPicturePO extends AbstractBasePO{
