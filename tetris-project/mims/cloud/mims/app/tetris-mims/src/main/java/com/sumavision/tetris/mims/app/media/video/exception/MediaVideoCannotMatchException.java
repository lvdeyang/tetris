...
public class MediaVideoCannotMatchException extends BaseException{
	private final Logger LOG = LoggerFactory.getLogger(MediaVideoCannotMatchException.class);

	private static final long serialVersionUID = 1L;

	public MediaVideoCannotMatchException(
			String uuid, 
			String pName, 
			long pLastModified,
			long pSize,
