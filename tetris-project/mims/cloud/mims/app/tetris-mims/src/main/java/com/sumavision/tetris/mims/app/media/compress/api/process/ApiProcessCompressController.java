package com.sumavision.tetris.mims.app.media.compress.api.process;
...
@Controller
@RequestMapping(value = "/api/process/compress")
public class ApiProcessCompressController {
	...
	public Object uploadReviewPassed(
		...
		mediaCompressService.uploadReviewPassed(id);
		return null;
	}
	...
	public Object uploadReviewRefuse(
			Long id,
			HttpServletRequest request) throws Exception{
		mediaCompressService.uploadReviewRefuse(id);
		return null;
	}
	...
	public Object editReviewPassed(
			...
			String remarks,
			HttpServletRequest request) throws Exception{
		mediaCompressService.editReviewPassed(id, name, tags, keyWords, remarks);
		return null;
	}
	...
	public Object editReviewRefuse(
			Long id,
			HttpServletRequest request) throws Exception{
		mediaCompressService.editReviewRefuse(id);
		return null;
	}
	...
	public Object deleteReviewPassed(
			Long id,
			HttpServletRequest request) throws Exception{
		mediaCompressService.deleteReviewPassed(id);
		return null;
	}
	...
	public Object deleteReviewRefuse(
			Long id,
			HttpServletRequest request) throws Exception{
		mediaCompressService.deleteReviewRefuse(id);
		return null;
	}
