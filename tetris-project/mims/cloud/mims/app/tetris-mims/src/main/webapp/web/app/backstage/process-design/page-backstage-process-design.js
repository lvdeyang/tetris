 ...
 */
define([
    'text!' + window.APPPATH + 'backstage/process-design/page-backstage-process-design.html',
    'config',
    'restfull',
    'jquery',
    'context',
    ...
    'element-ui',
    'mi-frame',
    'css!' + window.APPPATH + 'backstage/process-design/page-backstage-process-design.css'
], function(tpl, config, ajax, $, context, commons, BpmnExtJS, Vue){

    var pageId = 'page-backstage-process-design';
