...
module.exports = {
  ...
  ALARM_ROOT:  useLocalRouteConst? '"http://__requestIP__:8097"' : '"http://10.10.40.207:8097"',
  WEBSOCKET_URL : useLocalRouteConst? '"ws://__requestIP__:8097/"': '"ws://10.10.40.207:8097/"'
}