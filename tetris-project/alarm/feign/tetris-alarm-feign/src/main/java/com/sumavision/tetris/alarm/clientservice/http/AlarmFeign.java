...
public interface AlarmFeign {
	...
	@RequestMapping(value = "/alarm/querySubUntreatedAlarms", method = RequestMethod.POST)
	public JSONObject querySubUntreatedAlarms(@RequestParam(value = "serviceName") String serviceName) throws Exception;
