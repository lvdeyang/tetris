...
<body>
    <div id="app" class="page-wrapper" v-loading.fullscreen.lock="loading">
        <zk-footer-dialog-change-scheme ref="zkFooterDialogChangeScheme"></zk-footer-dialog-change-scheme>
    </div>
</body>
<script type="text/javascript" src="<%=basePath %>web/lib/frame/requireJS/require.js" defer async="true" data-main="<%=basePath %>web/app/zk/footer/dialog/change-scheme/main"></script>
