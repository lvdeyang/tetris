    ...
    var init = function(){
        ...
        new Vue({
            ...
            methods:{
                ...
                handleCreateSingleBundleTerminalBatch:function(){
                    var self = this;
                    ...
                    self.$msgbox({
                        ...
                        message:h('div', null, [
                            ...
                            h('div', {class:'el-message-box__message'}, [
                                h('p', null, ['创建单设备终端前，请先确保在资源管理中导入对应设备的设备模板'])
                            ])
                        ]),
                        type:'wraning',
                        ...
                        beforeClose:function(action, instance, done){
                            ...
                            if(action === 'confirm'){
                                ajax.post('/tetris/bvc/model/terminal/create/single/bundle/terminal/batch', null, function(data, status, message){
                ...
                gotoTerminalEditor:function(scope){
                    var self = this;
                    var row = scope.row;
                    window.location.hash = '#/page-terminal-editor/' + row.id + '/' + row.name;
                },
