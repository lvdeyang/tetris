    ...
    var init = function(){
        ...
        new Vue({
            ...
            methods:{
                ...
                handleHallSizeChange:function(pageSize){
                    var self = this;
                    self.hall.page.pageSize = pageSize;
                    self.loadHalls(1);
                },
                ...
                handleCreateHallBatchClose:function(){
                    ...
                    self.dialog.createHallBatch.terminal = '';
                ...
                loadBundles:function(currentPage){
                    ...
                    ajax.post('/tetris/bvc/business/terminal/bundle/user/permission/load/bundles', {
                        ...
                        deviceModel:self.dialog.createHallBatch.terminal.deviceMode,
                        currentPage:currentPage,
                ...
                handleBundleSizeChange:function(pageSize){
                    var self = this;
                    self.dialog.selectBundle.page.pageSize = pageSize;
                    self.loadBundles(1);
                },
