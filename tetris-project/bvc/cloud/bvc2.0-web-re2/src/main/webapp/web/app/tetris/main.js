require.config({
    ...
    paths: {
        ...
        'page-terminal-editor':window.APPPATH + 'tetris/model/terminal/editor/page-terminal-editor',
        //'page-terminal-channel':window.APPPATH + 'tetris/model/terminal/page-terminal-channel',
        ...
        'page-internal-agenda':window.APPPATH + 'tetris/model/agenda/page-internal-agenda',
        'page-custom-agenda':window.APPPATH + 'tetris/model/agenda/page-custom-agenda',
        'page-combine-virtual-source':window.APPPATH + 'tetris/model/agenda/combine/page-combine-virtual-source',
        'page-internal-agenda-forward':window.APPPATH + 'tetris/model/agenda/page-internal-agenda-forward',
        ...
        'page-layout':window.APPPATH + 'tetris/model/layout/page-layout',
        'page-layout-forward':window.APPPATH + 'tetris/model/layout/forward/page-layout-forward',
        ...
        'page-group':window.APPPATH + 'tetris/business/group/page-group'
    },
    shim:{
        'vue':{
            exports: 'Vue'
