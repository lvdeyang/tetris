define([
    'text!' + window.APPPATH + 'component/bvc2-monitor-live/channel/bvc2-monitor-channel-live.html',
    'restfull',
    'jquery',
    'vue',
    'element-ui',
    ...
    'css!' + window.APPPATH + 'component/bvc2-monitor-live/channel/bvc2-monitor-channel-live.css',
	...
	//组件名称
    var pluginName = 'bvc2-monitor-channel-live';
    ...
    Vue.component(pluginName, {
        ...
        mounted:function(){
            ...
            ajax.post('/monitor/device/find/tree/by/folder/type/2/false/live', null, function(data){
