define([
    'text!' + window.APPPATH + 'component/bvc2-monitor-live-user-list/bvc2-monitor-live-user-list.html',
    'restfull',
    'jquery',
    'vue',
    'element-ui',
    ...
    'css!' + window.APPPATH + 'component/bvc2-monitor-live-user-list/bvc2-monitor-live-user-list.css'
], function(tpl, ajax, $, Vue){

	//组件名称
    var pluginName = 'bvc2-monitor-live-user-list';
    ...
    Vue.component(pluginName, {
        ...
        methods:{
            load:function(currentPage){
                ...
                ajax.post('/monitor/live/load/user/lives', {
            ...
            rowDelete:function(scope){
                ...
                self.$msgbox({
                    ...
                    beforeClose:function(action, instance, done){
                        ...
                        if(action === 'confirm'){
                            ajax.post('/monitor/live/stop/live/user/' + row.id, null, function(data, status){
