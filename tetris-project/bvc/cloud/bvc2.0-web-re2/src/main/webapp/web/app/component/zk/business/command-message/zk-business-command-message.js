define([
    'text!' + window.APPPATH + 'component/zk/business/command-message/zk-business-command-message.html',
    'restfull',
    'jquery',
    'vue',
    'config',
    'element-ui',
    'css!' + window.APPPATH + 'component/zk/business/command-message/zk-business-command-message.css'
], function(tpl, ajax, $, Vue,config){

	//组件名称
    var pluginName = 'zk-business-command-message';
    ...
    Vue.component(pluginName, {
        ...
        mounted:function(){
            var self = this;
            self.qt = new QtContext('commandMessage', function(){
