package com.sumavision.bvc.error;
...
public class ErrorInfoBuilder implements HandlerExceptionResolver, Ordered {
     ...
     */
    @Override
    public ModelAndView resolveException(HttpServletRequest request, HttpServletResponse response, @NonNull Object handler, Exception ex) {
