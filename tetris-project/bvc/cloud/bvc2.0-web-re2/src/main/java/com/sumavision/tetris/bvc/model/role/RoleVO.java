...
public class RoleVO extends AbstractBaseVO<RoleVO, RolePO>{
	...
	public RoleVO setChannels(List<RoleChannelVO> channels) {
	...
	public RoleVO set(RolePO entity) throws Exception {
		this.setId(entity.getId())
			...
			.setInternalRoleType(entity.getInternalRoleType()==null?null:entity.getInternalRoleType().toString())
			.setInternalRoleTypeName(entity.getInternalRoleType()==null?null:entity.getInternalRoleType().getName())
