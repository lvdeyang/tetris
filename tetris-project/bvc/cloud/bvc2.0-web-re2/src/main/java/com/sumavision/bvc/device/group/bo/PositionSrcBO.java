...
public class PositionSrcBO {
	 ...
	 */
	public PositionSrcBO set(BusinessCombineVideoPositionPO position, int width, int height){
		...
		if(srcs!=null && srcs.size()>0){
			for(BusinessCombineVideoSrcPO src:srcs){
				if(!src.isHasSource()) continue;
