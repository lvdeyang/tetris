...
//			BusinessPlayerVO _player = new BusinessPlayerVO().set(player);
	...
	public Object startSpecifyPlayer(
		...
		synchronized (new StringBuffer().append(lockStartPrefix).append(callUserId).toString().intern()) {
			...
			userCallService.userCallUser(callUser, calledUser, serial, null, null);
			/*TODO:CommandGroupUserPlayerPO player = commandUserServiceImpl.userCallUser_Cascade(callUser, calledUser, serial, null);
