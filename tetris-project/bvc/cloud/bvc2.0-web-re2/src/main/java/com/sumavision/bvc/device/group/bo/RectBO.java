...
public class RectBO {
	...
	public RectBO set(LayoutForwardPO layoutForward, String channelId){
		this.setChannel(channelId)
			.setRect_id("rect_" + channelId.split("_")[1])
			.setX(Integer.parseInt(layoutForward.getX()))
			.setY(Integer.parseInt(layoutForward.getY()))
			.setWidth(Integer.parseInt(layoutForward.getWidth()))
			.setHeight(Integer.parseInt(layoutForward.getHeight()))
			.setZ_index(Integer.parseInt(layoutForward.getzIndex()));
		return this;
	}
