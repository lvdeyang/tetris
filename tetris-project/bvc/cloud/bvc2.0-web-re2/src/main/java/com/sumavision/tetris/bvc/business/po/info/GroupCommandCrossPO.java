 ...
 */
@Entity
@Table(name = "TETRIS_BVC_BUSINESS_GROUP_COMMAND_CROSS")
public class GroupCommandCrossPO extends AbstractBasePO{
	...
	public GroupCommandCrossPO(){
		
	}
	
	public GroupCommandCrossPO(Long groupId){
		this.groupId = groupId;
	}
}
