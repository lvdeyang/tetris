...
public class RoleChannelTerminalChannelPermissionController {

	@Autowired
	private RoleChannelTerminalChannelPermissionQuery roleChannelTerminalBundleChannelPermissionQuery;
	
	@Autowired
	private RoleChannelTerminalChannelPermissionService roleChannelTerminalBundleChannelPermissionService;
	 ...
	 * @return List<RoleChannelTerminalChannelPermissionVO> 通道关联列表
	 */
	@JsonBody
	@ResponseBody
	...
	@JsonBody
	@ResponseBody
	@RequestMapping(value = "/load/by/role/id/and/terminal/id")
	public Object loadByRoleIdAndTerminalId(
			Long roleId,
			Long terminalId,
			HttpServletRequest request) throws Exception{
		
		return roleChannelTerminalBundleChannelPermissionQuery.loadByRoleIdAndTerminalId(roleId, terminalId);
	}
