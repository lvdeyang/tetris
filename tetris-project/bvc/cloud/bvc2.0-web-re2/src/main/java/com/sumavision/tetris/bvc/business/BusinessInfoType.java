...
//	COOPERATE_MEMBER_COMMAND("协同成员的业务", "cooperationMember"),//协同指挥成员观看其它成员的是时候使用
	...
	SECRET_COMMAND("专向会议业务", "专向", "command", false),
	CROSS_COMMAND("越级指挥业务", "越级指挥", "command", true),
	COOPERATESERVICE_COMMAND("协同指挥业务", "协同指挥", "command", true),
	COMMAND_FORWARD("会议转发", "媒体转发", "commandForwardDevice", true),
	...
	COMBINE_VIDEO_VIRTUAL_SOURCE("合屏虚拟源", "", "combine_video_virtual_source", false);//仅用于标记议程类型，不用于播放器业务
