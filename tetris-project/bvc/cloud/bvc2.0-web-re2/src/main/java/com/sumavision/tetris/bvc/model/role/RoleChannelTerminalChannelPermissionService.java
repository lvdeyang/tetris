...
@Service
public class RoleChannelTerminalChannelPermissionService {
	...
	public List<RoleChannelTerminalChannelPermissionVO> add(
			Long roleId,
			Long roleChannelId,
			Long terminalId,
		...
		List<RoleChannelTerminalChannelPermissionPO> entities = new ArrayList<RoleChannelTerminalChannelPermissionPO>();
		...
		if(terminalChannels!=null && terminalChannels.size()>0){
			for(TerminalChannelPO terminalChannel:terminalChannels){
				RoleChannelTerminalChannelPermissionPO entity = new RoleChannelTerminalChannelPermissionPO();
			...
			for(RoleChannelTerminalChannelPermissionPO entity:entities){
				RoleChannelTerminalChannelPermissionVO permission = new RoleChannelTerminalChannelPermissionVO();
	...
	public void delete(Long id) throws Exception{
		RoleChannelTerminalChannelPermissionPO permission = roleChannelTerminalBundleChannelPermissionDao.findOne(id);
		if(permission != null){
