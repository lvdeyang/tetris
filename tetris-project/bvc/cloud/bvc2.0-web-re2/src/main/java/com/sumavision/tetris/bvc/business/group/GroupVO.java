...
public class GroupVO extends AbstractBaseVO<GroupVO, GroupPO> {
	...
	public GroupVO setOrderGroupType(String orderGroupType) {
	...
	public GroupVO setOrderBeginTime(String orderBeginTime) {
	...
	public GroupVO setOrderEndTime(String orderEndTime) {
	...
	public GroupVO setGroupLock(String groupLock) {
	...
	public GroupVO setGroupNumber(Long groupNumber) {
	...
	public GroupVO set(GroupPO entity) throws Exception {
		this.setId(entity.getId())
		    ...
		    .setOrderGroupType(entity.getOrderGroupType()==null?"":entity.getOrderGroupType().toString())
		    .setOrderBeginTime(entity.getOrderBeginTime()==null?"":DateUtil.format(entity.getOrderBeginTime()))
		    .setOrderEndTime(entity.getOrderEndTime()==null?"":DateUtil.format(entity.getOrderEndTime()))
		    .setGroupLock(entity.getGroupLock()==null?"":entity.getGroupLock().toString())
		    .setGroupNumber(entity.getGroupNumber()==null?-1L:entity.getGroupNumber());
		return this;
	}
