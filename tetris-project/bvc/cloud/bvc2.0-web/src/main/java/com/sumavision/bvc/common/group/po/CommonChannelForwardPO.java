 ...
 */
@Entity
@Table(name="BVC_COMMON_CHANNEL_FOWARD")
public class CommonChannelForwardPO extends AbstractBasePO{
	 ...
	 */
	public CommonChannelForwardPO generateVideoForward(CommonConfigVideoSrcPO src, CommonConfigVideoDstPO dst){
	 ...
	 * @return ChannelFowardPO 视频转发数据
	 */
	public CommonChannelForwardPO generateVideoForward(CommonConfigVideoSrcPO src, CommonMemberChannelPO dst){
		this.setForwardSourceType(ForwardSourceType.FORWARVIDEO);
		this.setForwardDstType(ForwardDstType.CHANNEL);
		if(src != null){
			this.setSourceMemberId(src.getMemberId());
	 ...
	 * @return ChannelFowardPO 视频转发数据
	 */
	public CommonChannelForwardPO generateVideoForward(CommonConfigVideoSrcPO src, CommonBusinessRolePO role, CommonMemberChannelPO dst){
		this.setForwardSourceType(ForwardSourceType.FORWARVIDEO);
	 ...
	 * @return ChannelFowardPO 视频转发数据
	 */
	public CommonChannelForwardPO generateVideoForward(CommonConfigVideoSmallSrcPO src, CommonMemberChannelPO dst){
		this.setForwardSourceType(ForwardSourceType.FORWARVIDEO);
		this.setForwardDstType(ForwardDstType.CHANNEL);
		if(src != null){
			this.setSourceMemberId(src.getMemberId());
	 ...
	 * @return ChannelFowardPO 视频转发数据
	 */
	public CommonChannelForwardPO generateVideoForward(CommonConfigVideoSmallSrcPO src, CommonBusinessRolePO role, CommonMemberChannelPO dst){
		this.setForwardSourceType(ForwardSourceType.FORWARVIDEO);
		this.setForwardDstType(ForwardDstType.ROLE);
		if(src != null){
			this.setSourceMemberId(src.getMemberId());
	 ...
	 */
	public CommonChannelForwardPO generateVideoForward(CommonMemberChannelPO src, CommonMemberChannelPO dst){
		this.setForwardSourceType(ForwardSourceType.FORWARVIDEO);
		this.setForwardDstType(ForwardDstType.CHANNEL);
		if(src != null){
	 ...
	 * @return ChannelForwardPO 通道转发
	 */
	public CommonChannelForwardPO generateVideoForward(CommonMemberChannelPO src, CommonBusinessRolePO role, CommonMemberChannelPO dst){
		this.setForwardSourceType(ForwardSourceType.FORWARVIDEO);
		this.setForwardDstType(ForwardDstType.ROLE);
		if(src != null){
			this.setSourceMemberId(src.getMember().getId());
	 ...
	 */
	public CommonChannelForwardPO generateCombineVideoForward(String combineVideoUuid, CommonConfigVideoDstPO dst){
	 ...
	 * @return ChannelFowardPO 合屏转发数据
	 */
	public CommonChannelForwardPO generateCombineVideoForward(String combineVideoUuid, CommonMemberChannelPO dst){
		this.setSourceMemberId(null);
		this.setSourceMemberChannelId(null);
		this.setSourceLayerId(null);
		this.setSourceBundleId(null);
	 ...
	 * @return ChannelFowardPO 合屏转发数据
	 */
	public CommonChannelForwardPO generateCombineVideoForward(String combineVideoUuid, CommonMemberChannelPO dst, CommonBusinessRolePO role){
		this.setSourceMemberId(null);
		this.setSourceMemberChannelId(null);
		this.setSourceLayerId(null);
		this.setSourceBundleId(null);
	 ...
	 */
	public CommonChannelForwardPO generateOverlap(CommonCombineVideoPO combineVideo){
		String bundleId = this.getBundleId();
		CommonCombineVideoPositionPO overlap = null;
		...
		if(positions!=null && positions.size()>0){
			for(CommonCombineVideoPositionPO position:positions){
				...
				CommonCombineVideoSrcPO src = srcs.iterator().next();
	 ...
	 */
	public CommonChannelForwardPO generateAudioForward(CommonMemberChannelPO encodeChannel, CommonMemberChannelPO decodeChannel){
	 ...
	 */
	public CommonChannelForwardPO generateCombineAudioForward(String combineAudioUuid, CommonMemberChannelPO decodeChannel){
	 ...
	 */
	public CommonChannelForwardPO copySource(CommonChannelForwardPO from){
