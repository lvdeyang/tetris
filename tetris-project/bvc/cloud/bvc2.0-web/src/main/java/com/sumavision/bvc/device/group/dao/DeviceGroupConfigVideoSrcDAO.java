...
@RepositoryDefinition(domainClass = DeviceGroupConfigVideoSrcPO.class, idClass = long.class)
public interface DeviceGroupConfigVideoSrcDAO extends MetBaseDAO<DeviceGroupConfigVideoSrcPO>{
	 ...
	 * @return List<DeviceGroupConfigVideoSrcPO> 视频源
	 */
	public List<DeviceGroupConfigVideoSrcPO> findByMemberChannelIdIn(Collection<Long> channelIds);
