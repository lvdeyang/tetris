 ...
 */
@Entity
@Table(name = "BVC_COMMON_AVTPL_GEARS")
public class CommonAvtplGearsPO extends AbstractBasePO{
	 ...
	 */
	public CommonAvtplGearsPO set(com.sumavision.bvc.system.po.AvtplGearsPO entity){
