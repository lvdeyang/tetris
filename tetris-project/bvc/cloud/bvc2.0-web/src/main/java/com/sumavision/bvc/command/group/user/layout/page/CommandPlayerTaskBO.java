 ...
 */
public class CommandPlayerTaskBO {
	...
	public CommandPlayerTaskBO setByVod(CommandVodPO vod){
	...
	public CommandPlayerTaskBO setSrcByForward(CommandGroupForwardPO forward){
