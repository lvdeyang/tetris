...
//	COOPERATE_MEMBER_COMMAND("协同成员的业务", "cooperationMember"),//协同指挥成员观看其它成员的是时候使用
	SPEAK_MEETING("会议发言业务", "speak", false),
	SECRET_COMMAND("专向会议业务", "secret", false),
	COMMAND_FORWARD("会议转发", "commandForward", true),
	COMMAND_FORWARD_DEVICE("会议转发设备", "commandForwardDevice", false),
	COMMAND_FORWARD_FILE("会议转发文件", "commandForwardFile", false),
	COMMAND_FORWARD_USER("会议转发用户", "commandForwardUser", false),
	PLAY_COMMAND_RECORD("播放会议录像", "vodRecordFile", true),
	PLAY_VOD("点播", "vod", true),
	PLAY_FILE("点播文件", "vodResourceFile", false),
	PLAY_USER("点播用户", "vodUser", false),
	PLAY_USER_ONESELF("本地视频", "vodUserLocal", false),//看自己的编码器，如果vodUser，则按照普通点播来处理；2月20日新增localPreview用于观看摄像头；4月23日新增vodUserLocal专用于点播本人
	PLAY_DEVICE("点播设备", "vodDevice", false),
	PLAY_RECORD("播放录像", "vodRecordFile", true),
	USER_CALL("用户呼叫", "callUser", true),
	USER_VOICE("语音对讲", "voiceIntercom", true);
