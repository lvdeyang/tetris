 ...
 */
@Entity
@Table(name="BVC_COMMON_COMBINE_AUDIO_SRC")
public class CommonCombineAudioSrcPO extends AbstractBasePO{
	...
	/** 关联混音 */
	private  CommonCombineAudioPO combineAudio;
	...
	public CommonCombineAudioPO getCombineAudio() {
		return combineAudio;
	}

	public void setCombineAudio(CommonCombineAudioPO combineAudio) {
	 ...
	 */
	public CommonCombineAudioSrcPO set(CommonMemberChannelPO entity){
