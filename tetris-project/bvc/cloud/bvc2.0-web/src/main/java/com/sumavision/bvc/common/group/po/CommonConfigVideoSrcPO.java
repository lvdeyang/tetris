...
@Entity
@Table(name="BVC_COMMON_CONFIG_VIDEO_SRC")
public class CommonConfigVideoSrcPO extends AbstractBasePO{
	...
	/** 关联分屏布局 */
	private CommonConfigVideoPositionPO position;
	...
	public CommonConfigVideoPositionPO getPosition() {
		return position;
	}

	public void setPosition(CommonConfigVideoPositionPO position) {
