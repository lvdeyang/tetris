...
/**
 * 
 * @ClassName:  CombineAudioOperateBO   
 * @Description:混音设置/更新操作BO 
 * @author: 
...
@Getter
@Setter
public class CombineAudioOperateBO {
	...
	public String toString() {
		return "CombineAudioOperateBO [taskId=" + taskId + ", lock_type=" + lock_type + ", base_type=" + base_type
				+ ", codec_param=" + codec_param + ", layerId=" + layerId + ", bundleId=" + bundleId + ", channelId="
				+ channelId + ", uuid=" + uuid + ", src=" + src + "]";
	}
