 ...
 */
@Entity
@Table(name="BVC_DEVICE_GROUP_BUSINESS_ROLE")
public class DeviceGroupBusinessRolePO extends AbstractBasePO{
	 ...
	 */
	public DeviceGroupBusinessRolePO set(com.sumavision.bvc.system.po.BusinessRolePO entity){
