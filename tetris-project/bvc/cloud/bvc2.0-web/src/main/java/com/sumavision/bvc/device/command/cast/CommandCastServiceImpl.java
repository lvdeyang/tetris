...
import com.sumavision.bvc.command.group.dao.CommandGroupUserPlayerCastDeviceDAO;
...
public class CommandCastServiceImpl {
	...
	@Autowired
	private CommandGroupUserPlayerCastDeviceDAO commandGroupUserPlayerCastDeviceDao;
