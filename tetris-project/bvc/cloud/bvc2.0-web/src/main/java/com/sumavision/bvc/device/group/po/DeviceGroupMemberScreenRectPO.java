 ...
 */
@Entity
@Table(name = "BVC_DEVICE_GROUP_MEMBER_SCREEN_RECT")
public class DeviceGroupMemberScreenRectPO extends AbstractBasePO{
	...
	/** 关联设备组成员屏幕 */
	private DeviceGroupMemberScreenPO screen;
	...
	public DeviceGroupMemberScreenPO getScreen() {
		return screen;
	}

	public void setScreen(DeviceGroupMemberScreenPO screen) {
		this.screen = screen;
	}	
	 ...
	 */
	public static final class RectComparatorFromPO implements Comparator<DeviceGroupMemberScreenRectPO>{
		@Override
		public int compare(DeviceGroupMemberScreenRectPO o1, DeviceGroupMemberScreenRectPO o2) {
