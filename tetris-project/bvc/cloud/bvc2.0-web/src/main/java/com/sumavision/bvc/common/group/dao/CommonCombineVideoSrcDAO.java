...
@RepositoryDefinition(domainClass = CommonCombineVideoSrcPO.class, idClass = long.class)
public interface CommonCombineVideoSrcDAO extends MetBaseDAO<CommonCombineVideoSrcPO>{
