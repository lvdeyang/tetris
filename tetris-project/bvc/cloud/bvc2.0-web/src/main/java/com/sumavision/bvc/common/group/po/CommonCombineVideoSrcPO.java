 ...
 */
@Entity
@Table(name="BVC_COMMON_COMBINE_VIDEO_SRC")
public class CommonCombineVideoSrcPO extends AbstractBasePO{
	...
	/** 关联合屏的分屏 */
	private  CommonCombineVideoPositionPO position;
	...
	public CommonCombineVideoPositionPO getPosition() {
		return position;
	}

	public void setPosition(CommonCombineVideoPositionPO position) {
	 ...
	 * @throws
	 */
	public CommonCombineVideoSrcPO set(CommonConfigVideoSrcPO src){
	 ...
	 * @return
	 */
	public CommonCombineVideoSrcPO set(CommonMemberChannelPO channel){
		this.setType(CombineVideoSrcType.CHANNEL);
