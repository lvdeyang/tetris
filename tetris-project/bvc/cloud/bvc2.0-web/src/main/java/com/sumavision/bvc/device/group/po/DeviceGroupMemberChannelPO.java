 ...
 */
@Entity
@Table(name="BVC_DEVICE_GROUP_MEMBER_CHANNEL")
public class DeviceGroupMemberChannelPO extends AbstractBasePO{
	 ...
	 */
	public static final class ChannelComparatorFromPO implements Comparator<DeviceGroupMemberChannelPO>{
		@Override
		public int compare(DeviceGroupMemberChannelPO o1, DeviceGroupMemberChannelPO o2) {
