...
/**
 * @ClassName: 指挥中转发点播内容，包括。同 CommandGroupForwardPO
 * @author zsy
 * @date 2019年11月14日 上午10:11:22 
 */
@Entity
@Table(name="BVC_COMMAND_GROUP_FORWARD_DEMAND")
public class CommandGroupForwardDemandPO extends AbstractBasePO{
...
//		this.srcMemberId = srcMemberId;
	...
	public CommandGroupForwardDemandPO setDstPlayer(CommandGroupUserPlayerPO player) throws Exception{
	...
	public CommandGroupForwardDemandPO clearDst() {
