define([
    'text!' + window.APPPATH + 'group/preview/page-group-preview.html',
    'restfull',
    'config',
    'context',
    'commons',
    ...
    var init = function(p){
        ...
        ajax.get('/device/group/preview/query/code/' + p.id, null, function(data){
            ...
            var v_groupControl = window.v_groupList = new Vue({
                ...
                methods:{
                    ...
                    saveLayout:function(config, video, websiteDraw, position, dst, roleDst, done, layout){
                        var _uri = '';
            ...
            v_groupControl.$refs.autoLayout.setLayout({
                column:button1.layout.basic.column,
                row:button1.layout.basic.row,
                cellspan:button1.layout.cellspan,
                name:button1.layout.name,
                editable:false
            });
