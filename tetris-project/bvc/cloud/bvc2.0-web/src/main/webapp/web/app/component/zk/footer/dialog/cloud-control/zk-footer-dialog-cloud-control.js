define([
    'text!' + window.APPPATH + 'component/zk/footer/dialog/cloud-control/zk-footer-dialog-cloud-control.html',
    'restfull',
    'jquery',
    'vue',
    'config',
    'element-ui',
    'date',
    'css!' + window.APPPATH + 'component/zk/footer/dialog/cloud-control/zk-footer-dialog-cloud-control.css'
], function (tpl, ajax, $, Vue, config) {

    //组件名称
    var pluginName = 'zk-footer-dialog-cloud-control';
    ...
    Vue.component(pluginName, {
        ...
        mounted: function () {
            var self = this;
            self.qt = new QtContext('footerDialogCloudControl', function () {
                //初始化ajax
                ajax.init({
