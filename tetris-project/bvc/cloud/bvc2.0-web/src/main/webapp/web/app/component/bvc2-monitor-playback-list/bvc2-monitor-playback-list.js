define([
    'text!' + window.APPPATH + 'component/bvc2-monitor-playback-list/bvc2-monitor-playback-list.html',
    'restfull',
    'jquery',
    'vue',
    'element-ui',
    ...
    'css!' + window.APPPATH + 'component/bvc2-monitor-playback-list/bvc2-monitor-playback-list.css'
], function(tpl, ajax, $, Vue){

	//组件名称
    var pluginName = 'bvc2-monitor-playback-list';
    ...
    Vue.component(pluginName, {
        ...
        methods:{
            load:function(currentPage){
                ...
                ajax.post('/monitor/record/playback/load', {
            ...
            rowDelete:function(scope){
                ...
                self.$msgbox({
                    ...
                    beforeClose:function(action, instance, done){
                        ...
                        if(action === 'confirm'){
                            ajax.post('/monitor/record/playback/remove/' + row.id, null, function(data, status){
            ...
            onSelectedOsd:function(osd, done, endLoading){
                ...
                if(task.osdId != osd.id){
                    ajax.post('/monitor/record/playback/change/osd', {
                        taskId:task.id,
                        osdId:osd.id
