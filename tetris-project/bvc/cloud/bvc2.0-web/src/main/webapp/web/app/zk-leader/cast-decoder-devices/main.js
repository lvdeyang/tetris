require.config({
    ...
    paths: {
        ...
        /* components */
        'zk-footer-dialog-cast-decoder-devices':window.APPPATH + 'component/zk-leader/cast-decoder-devices/leader-cast-decoder-devices'
...
require([
    ...
    'restfull',
    'element-ui',
    'zk-footer-dialog-cast-decoder-devices'
