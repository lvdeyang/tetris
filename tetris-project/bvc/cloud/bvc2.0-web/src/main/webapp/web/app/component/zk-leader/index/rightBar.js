        ...
        methods: {
          ...
          //指挥工作台的按钮
            addCommandMember:function(){
                ...
                self.qt.window('/router/zk/leader/add/member', {id:self.group.current.id, type:self.group.current.type}, {width:980, height:600});
            },
            ...
            cooperativeCommand:function(){
                ...
                self.qt.window('/router/zk/leader/cooperation', {id:self.group.current.id, type:self.group.current.type}, {width:980, height:600});
            },
            commandForward:function(){
                var self = this;
                if(!self.buttons.commandForward) return;
                self.qt.window('/router/zk/leader/forward', {id:self.group.current.id}, {width:1024, height:768, title:'指挥转发'});
            },
            silenceUp:function(){
                var self = this;
            ...
            sendMessage:function(){
                ...
                self.qt.window('/router/zk/leader/send/message', {id:self.group.current.id}, {width:1224, height:768});
            },
