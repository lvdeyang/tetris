define([
    'text!' + window.APPPATH + 'component/zk/settings/zk-settings.html',
    'restfull',
    'jquery',
    'vue',
    'config',
    'element-ui',
    'css!' + window.APPPATH + 'component/zk/settings/zk-settings.css'
            ...
            handleCallResponseModeChange:function(v){
                ...
                ajax.post('/command/settings/call/response/mode', {mode:parseInt(v)?'auto':'manual'}, function(data, status){
                    if(status !== 200){
                        ...
                        self.qt.linkedWebview('business', {id:'responseModeChange', params:parseInt(v)?'auto':'manual'});
                    }
            ...
            handleVideoSendAnswerModeChange:function(v){
                ...
                ajax.post('/command/settings/video/send/answer/mode', {mode:parseInt(v)?'auto':'manual'}, function(data, status){
                    if(status !== 200){
                        ...
                        self.qt.linkedWebview('business', {id:'sendAnswerModeChange', params:parseInt(v)?'auto':'manual'});
                    }
                }, null, [403,404,408,409,500]);
            },
