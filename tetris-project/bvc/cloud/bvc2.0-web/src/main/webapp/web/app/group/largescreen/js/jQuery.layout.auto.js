...
+function($){
    ...
    var defultOptions = {
        ...
        editable:true,
        event:{
            //drop:function(layout, e){},
            //cellspan:function(layout){}
        }
    };
    ...
    var publics = {
            ...
            if(typeof options.event.drop === 'function'){
                ...
                $table.find('tbody td').each(function(){
                    ...
                    $td[0].addEventListener('drop', function(e){
                        ...
                        var l  = publics.getLayout.apply($this[0]);
                        options.event.drop.apply(this, [l, e]);
                    });
        ...
        //获取屏幕数据
        getLayout:function(withoutData){
            var $cell = $(this);
            var $table = $cell.closest('.layout-auto');
            var options = $table.data('options');
            var cell = privates.queryCell.apply($cell[0], [options]);
            ...
            if(!withoutData){
                l.data = $cell.data('business-cache');
            }
            return l;
        },
    ...
    var privates = {
        ...
        cellspan:function(r, b, history){
            ...
            if(history){
                ...
                var l = publics.getLayout.apply($cell);

                if(typeof _options.event.cellspan === 'function'){
                    _options.event.cellspan.apply($cell, [l]);
                }
            }
        },
    ...
    $(document).on('mousedown.layout.auto.cell', '.layout-auto .cell', function(e1){
        ...
        if(!$div[0]){
            ...
            x0 = parseFloat($div.css('left'));
            y0 = parseFloat($div.css('top'));
        }
