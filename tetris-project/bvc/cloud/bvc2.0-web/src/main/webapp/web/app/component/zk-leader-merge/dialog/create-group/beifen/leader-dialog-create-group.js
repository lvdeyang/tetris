    ...
    Vue.component(pluginName, {
        ...
        methods: {
            ...
            filterLevel: function() {
                var levels = [this.selected1, this.selected2, this.selected3, this.selected4, this.selected5];
            ...
            searchBlur: function (e, num) {
                if (num === 1) {
                    this.selected1 = e.target.value.trim();
                } else if (num === 2) {
                    this.selected2 = e.target.value.trim();
                } else if (num === 3) {
                    this.selected3 = e.target.value.trim();
                } else if (num === 4) {
                    this.selected4 = e.target.value.trim();
                } else if (num === 5) {
                    this.selected5 = e.target.value.trim();
                }
                this.startFilterData();
            },
