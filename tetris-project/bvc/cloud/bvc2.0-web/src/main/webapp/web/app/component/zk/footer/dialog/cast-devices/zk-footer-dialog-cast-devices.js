define([
    'text!' + window.APPPATH + 'component/zk/footer/dialog/cast-devices/zk-footer-dialog-cast-devices.html',
    'restfull',
    'jquery',
    'vue',
    'config',
    'element-ui',
    'css!' + window.APPPATH + 'component/zk/footer/dialog/cast-devices/zk-footer-dialog-cast-devices.css'
], function(tpl, ajax, $, Vue, config){

	//组件名称
    var pluginName = 'zk-footer-dialog-cast-devices';
    ...
    Vue.component(pluginName, {
        ...
        mounted:function(){
            var self = this;
            self.qt = new QtContext('footerDialogCastDevices', function(){
                //初始化ajax
                ajax.init({
