...
<body>
    <div id="app" class="page-wrapper" v-loading.fullscreen.lock="loading">
        <zk-footer-dialog-save-scheme ref="zkFooterDialogSaveScheme"></zk-footer-dialog-save-scheme>
    </div>
</body>
<script type="text/javascript" src="<%=basePath %>web/lib/frame/requireJS/require.js" defer async="true" data-main="<%=basePath %>web/app/zk/footer/dialog/save-scheme/main"></script>
