...
<body>
    <div id="app" class="page-wrapper" v-loading.fullscreen.lock="loading">
        <zk-settings></zk-settings>
    </div>
</body>
<script type="text/javascript" src="qrc:///qtwebchannel/qwebchannel.js"></script>
<script type="text/javascript" src="<%=basePath %>web/commons/qt/QtContext.js"></script>
<script type="text/javascript" src="<%=basePath %>web/lib/frame/requireJS/require.js" defer async="true" data-main="<%=basePath %>web/app/zk-leader/settings/main"></script>
</html>