...
<head>
    ...
    <title>融合通信平台-频道直播</title>
</head>
<body>
    <div id="app" class="page-wrapper" v-loading.fullscreen.lock="loading">
        <bvc2-monitor-channel-live ref="bvc2MonitorChannelLive"></bvc2-monitor-channel-live>
        <bvc2-monitor-user-called-message></bvc2-monitor-user-called-message>
        <bvc2-monitor-call></bvc2-monitor-call>
    </div>
</body>
<script type="text/javascript" src="<%=basePath %>web/lib/frame/requireJS/require.js" defer async="true" data-main="<%=basePath %>web/app/monitor/live/channelLiveMain"></script>
</html>