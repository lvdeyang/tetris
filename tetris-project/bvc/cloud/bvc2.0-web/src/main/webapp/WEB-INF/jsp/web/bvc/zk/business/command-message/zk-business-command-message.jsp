...
<head>
    ...
    <!-- icons -->
    <link rel="stylesheet" type="text/css" href="<%=basePath %>web/lib/icon/Font-Awesome-3.2.1/css/font-awesome.min.css"/>
    ...
    <style type="text/css">
        ...
        *{font-family:'Microsoft YaHei';}
        ...
        body{background-color:#F2F3F7; min-width:1024px;}
...
<body>
    <div id="app" class="page-wrapper" v-loading.fullscreen.lock="loading">
        <zk-business-command-message ref="zkBusinessCommandMessage"></zk-business-command-message>
    </div>
</body>
<script type="text/javascript" src="<%=basePath %>web/lib/frame/requireJS/require.js" defer async="true" data-main="<%=basePath %>web/app/zk/business/command-message/main"></script>
