...
<head>
    ...
    <!-- components -->
    <link rel="stylesheet" type="text/css" href="<%=basePath %>web/app/component/bvc2-monitor-vod/bvc2-monitor-vod.css"/>

	<!-- theme 
	<link rel="stylesheet" type="text/css" href="<%=basePath %>web/theme/monitor92/monitor-92-theme.css"/>
	-->
    ...
    <title>融合通信平台-外部静态资源文件夹管理</title>
</head>
<body>
    <div id="app" class="page-wrapper" v-loading.fullscreen.lock="loading">
        <bvc2-monitor-external-folder ref="bvc2MonitorVod"></bvc2-monitor-external-folder>
        <bvc2-monitor-user-called-message></bvc2-monitor-user-called-message>
        <bvc2-monitor-call></bvc2-monitor-call>
    </div>
</body>
<script type="text/javascript" src="<%=basePath %>web/lib/frame/requireJS/require.js" defer async="true" data-main="<%=basePath %>web/app/monitor/external-folder/main"></script>
</html>