...
<head>
    ...
    <!-- components -->
    <link rel="stylesheet" type="text/css" href="<%=basePath %>web/app/component/bvc2-monitor-playback/bvc2-monitor-playback.css"/>
    ...
    <title>融合通信平台-回放</title>
</head>
<body>
    <div id="app" class="page-wrapper" v-loading.fullscreen.lock="loading">
        <bvc2-monitor-playback ref="bvc2MonitorPlayback"></bvc2-monitor-playback>
        <bvc2-monitor-user-called-message></bvc2-monitor-user-called-message>
        <bvc2-monitor-call></bvc2-monitor-call>
    </div>
</body>
<script type="text/javascript" src="<%=basePath %>web/lib/frame/requireJS/require.js" defer async="true" data-main="<%=basePath %>web/app/monitor/playback/main"></script>
</html>