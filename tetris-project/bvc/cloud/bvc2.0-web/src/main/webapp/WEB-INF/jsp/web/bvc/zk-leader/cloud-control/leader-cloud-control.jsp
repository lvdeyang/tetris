...
<body>
    <div id="app" class="page-wrapper" v-loading.fullscreen.lock="loading">
        <leader-cloud-control></leader-cloud-control>
    </div>
</body>
<script type="text/javascript" src="<%=basePath %>web/lib/frame/requireJS/require.js" defer async="true" data-main="<%=basePath %>web/app/zk-leader/cloud-control/main"></script>
