...
<body>
    <div id="app" class="page-wrapper" v-loading.fullscreen.lock="loading">
        <zk-settings ref="zkSettings"></zk-settings>
    </div>
</body>
<script type="text/javascript" src="<%=basePath %>web/lib/frame/requireJS/require.js" defer async="true" data-main="<%=basePath %>web/app/zk/settings/main"></script>
