...
<head>
    ...
    <title>融合通信平台-点播</title>
</head>
<body>
    <div id="app" class="page-wrapper" v-loading.fullscreen.lock="loading">
        <bvc2-monitor-vod ref="bvc2MonitorVod"></bvc2-monitor-vod>
        <bvc2-monitor-user-called-message></bvc2-monitor-user-called-message>
        <bvc2-monitor-call></bvc2-monitor-call>
    </div>
</body>
<script type="text/javascript" src="<%=basePath %>web/lib/frame/requireJS/require.js" defer async="true" data-main="<%=basePath %>web/app/monitor/vod/main"></script>
</html>