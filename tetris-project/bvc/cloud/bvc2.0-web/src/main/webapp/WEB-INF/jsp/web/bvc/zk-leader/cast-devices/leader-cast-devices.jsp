...
<body>
    <div id="app" class="page-wrapper" v-loading.fullscreen.lock="loading">
        <leader-cast-devices ref="zkFooterDialogCast-devices"></leader-cast-devices>
    </div>
</body>
<script type="text/javascript" src="<%=basePath %>web/lib/frame/requireJS/require.js" defer async="true" data-main="<%=basePath %>web/app/zk-leader/cast-devices/main"></script>
