 ...
 */
define([
    'text!' + window.APPPATH + 'access-point-param/page-access-point-param.html',
    'config',
    'jquery',
    'restfull',
    'context',
    ...
    'element-ui',
    'mi-frame',
    'css!' + window.APPPATH + 'access-point-param/page-access-point-param.css'
], function(tpl, config, $, ajax, context, commons, Vue){

    var pageId = 'page-access-point-param';
