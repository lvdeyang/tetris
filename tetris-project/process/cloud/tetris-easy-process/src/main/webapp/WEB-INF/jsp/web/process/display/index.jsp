...
<%
	...
	String processInstanceId = (String)request.getAttribute("__processInstanceId__");
%>
<!DOCTYPE HTML>
...
<head>
    ...
    <script type="text/javascript">
        ...
        window.PROCESSINSTANCEID = '<%=processInstanceId%>'
    </script>

    <title>媒体融合平台</title>
</head>
<body>
    <div id="app" v-loading.fullscreen.lock="loading"></div>
</body>
<script type="text/javascript" src="<%=basePath %>web/lib/frame/requireJS/require.js"  defer async="true" data-main="<%=basePath %>web/app/process-display/page-process-display"></script>
</html>