 ...
 */
define([
    'text!' + window.APPPATH + 'subordinate/user/page-subordinate-user.html',
    'config',
    'restfull',
    'jquery',
    'context',
    ...
    'mi-sub-title',
    'mi-user-dialog',
    'css!' + window.APPPATH + 'subordinate/user/page-subordinate-user.css'
], function (tpl, config, ajax, $, context, commons, Vue) {

    var pageId = 'page-subordinate-user';
    ...
    var init = function () {
        ...
        new Vue({
            ...
            data: {
                ...
                activeId: window.BASEPATH + 'index#/page-subordinate-user',
