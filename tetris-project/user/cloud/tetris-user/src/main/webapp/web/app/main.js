require.config({
  ...
  paths: {
    ...
    'page-login-variable-type':window.APPPATH + 'login-variable-type/page-login-variable-type',
    'page-login-variable':window.APPPATH + 'login-variable/page-login-variable',
  },
  shim: {
    'vue': {
      exports: 'Vue'
