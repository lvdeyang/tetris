package com.sumavision.tetris.api.zoom.android;
...
@Controller
@RequestMapping(value = "/api/zoom/android/auth")
public class ApiZoomAndroidAuthController {

	/** 安卓会议终端 */
	private static final TerminalType TERMINAL_TYPE = TerminalType.ZOOM_ANDROID;
