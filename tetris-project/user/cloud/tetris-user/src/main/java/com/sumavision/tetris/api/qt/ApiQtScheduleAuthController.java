...
@Controller
@RequestMapping(value = "/api/schedule/auth")
public class ApiQtScheduleAuthController {
	/** qt编单终端 */
	private static final TerminalType TERMINAL_TYPE = TerminalType.QT_CATALOGUE;
