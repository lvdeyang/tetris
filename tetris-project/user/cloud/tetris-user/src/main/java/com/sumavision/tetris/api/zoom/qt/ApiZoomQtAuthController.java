package com.sumavision.tetris.api.zoom.qt;
...
@Controller
@RequestMapping(value = "/api/zoom/qt/auth")
public class ApiZoomQtAuthController {

	/** QT会议终端 */
	private static final TerminalType TERMINAL_TYPE = TerminalType.ZOOM_QT;
