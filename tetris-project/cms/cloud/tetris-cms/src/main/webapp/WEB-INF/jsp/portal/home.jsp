...
<div id="body" style="margin:0 auto;width:1200px;">
    ...
    <div id="second-level">
    	  <image src="<%=basePath %>lib/images/5.jpg" style="width:660px;height:440px;margin-top:20px;float:left;"/>
		  <div style="width:500px;height:440px;float:left;margin-top:20px;margin-left:20px;">
		      <div style="width:100%;height:70px;">
			      <image src="<%=basePath %>lib/images/u107.png" style="width:20px;height:20px;line-height:65px;float:left;"/>
			      <div style="width:430px;height:65px;float:left;margin-left:5px;">
		      ...
		      <div style="width:100%;height:70px;">
			      <image src="<%=basePath %>lib/images/u107.png" style="width:20px;height:20px;line-height:65px;float:left;"/>
			      <div style="width:430px;height:65px;float:left;margin-left:5px;">
			          <span style="color:#172caa;font-size:18px;">北京数码视讯科技股份有限公司测试</span><br>
			          <span style="font-size:12px;color:#9f82bb">作者名称:Mr黄|已下载:1500</span>
			      </div>
		      </div>
		      <div style="width:100%;height:70px;">
			      <image src="<%=basePath %>lib/images/u107.png" style="width:20px;height:20px;line-height:65px;float:left;"/>
			      <div style="width:430px;height:65px;float:left;margin-left:5px;">
			          <span style="color:#172caa;font-size:18px;">北京数码视讯科技股份有限公司</span><br>
			          <span style="font-size:12px;color:#9f82bb">作者名称:Mr黄|已下载:1500</span>
			      </div>
		      </div>
		      <div style="width:100%;height:70px;">
			      <image src="<%=basePath %>lib/images/u107.png" style="width:20px;height:20px;line-height:65px;float:left;"/>
			      <div style="width:430px;height:65px;float:left;margin-left:5px;">
			          <span style="color:#172caa;font-size:18px;">北京数码视讯科技股份有限公司新媒体广播测试</span><br>
			          <span style="font-size:12px;color:#9f82bb">作者名称:Mr黄|已下载:1500</span>
			      </div>
		      </div>
		      <div style="width:100%;height:70px;">
    ...
    <div id="third-level" >
    	<div style="width:445px;height:510px;float:left;margin-top:20px;">
    	    ...
    	    <ul style="width:100%;float:left;margin-left:-20px;">
    	       <li style="color:#6283ff;padding:5px;"><a style="color:black" href="javascript:void(0)">湖北发布省寒流预警</a></li>
    	       <li style="color:#6283ff;padding:5px;"><a style="color:black" href="javascript:void(0)">湖北发布省寒流预警</a></li>
    	       <li style="color:#6283ff;padding:5px;"><a style="color:black" href="javascript:void(0)">湖北发布省寒流预警</a></li>
    	       <li style="color:#6283ff;padding:5px;"><a style="color:black" href="javascript:void(0)">北京数码视讯科技股份有限公司新媒体广播测试</a></li>
    	       <li style="color:#6283ff;padding:5px;"><a style="color:black" href="javascript:void(0)">湖北发布省寒流预警</a></li>
    	       <li style="color:#6283ff;padding:5px;"><a style="color:black" href="javascript:void(0)">北京数码视讯科技股份有限公司新媒体广播测试</a></li>
    	       <li style="color:#6283ff;padding:5px;"><a style="color:black" href="javascript:void(0)">湖北发布省寒流预警</a></li>
    	       <li style="color:#6283ff;padding:5px;"><a style="color:black" href="javascript:void(0)">湖北发布省寒流预警</a></li>
        ...
        <div style="width:440px;height:510px;float:left;margin-top:20px;">
            <div class="third-header" style="width:150px;hegith:30px;float:left">
                <span style="font-weight:bold;color:#466cfe">|</span>&nbsp;&nbsp;系统推荐</div>
                
                
             <ul style="width:100%;float:left;margin-left:-20px;">
    	       <li style="color:#bfbfbf;padding:5px;"><a style="color:black" href="javascript:void(0)">湖北发布省寒流预警</a></li>
    	       <li style="color:#bfbfbf;padding:5px;"><a style="color:black" href="javascript:void(0)">湖北发布省寒流预警</a></li>
    	       <li style="color:#bfbfbf;padding:5px;"><a style="color:black" href="javascript:void(0)">湖北发布省寒流预警</a></li>
    	       <li style="color:#bfbfbf;padding:5px;"><a style="color:black" href="javascript:void(0)">北京数码视讯科技股份有限公司新媒体广播测试</a></li>
    	       <li style="color:#bfbfbf;padding:5px;"><a style="color:black" href="javascript:void(0)">湖北发布省寒流预警</a></li>
    	       <li style="color:#bfbfbf;padding:5px;"><a style="color:black" href="javascript:void(0)">北京数码视讯科技股份有限公司新媒体广播测试</a></li>
    	       <li style="color:#bfbfbf;padding:5px;"><a style="color:black" href="javascript:void(0)">湖北发布省寒流预警</a></li>
    	       <li style="color:#bfbfbf;padding:5px;"><a style="color:black" href="javascript:void(0)">湖北发布省寒流预警</a></li>
        ...
        <div style="width:300px;height:510px;float:left;margin-top:20px;">
            <div class="third-header" style="width:150px;hegith:30px;float:left;">
