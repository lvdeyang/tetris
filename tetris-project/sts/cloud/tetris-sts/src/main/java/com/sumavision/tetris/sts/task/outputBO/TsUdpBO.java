...
import com.sumavision.tetris.sts.task.taskParamOutput.JsonTsUdpBO;
...
public class TsUdpBO extends CommonOutputBO{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3183316094645134818L;
	...
	public OutputCommon generateOutputCommon(OutputPO outputPO, ProgramPO programPO, OutputMediaEncodeMessage outputMediaEncodeMessage) {
		...
		JsonTsUdpBO jsonTsUdpBO = new JsonTsUdpBO();
		jsonTsUdpBO.setIp(outputPO.getIp());
		jsonTsUdpBO.setPort(outputPO.getPort());
		jsonTsUdpBO.setLocal_ip(outputPO.getLocalIp());
		jsonTsUdpBO.setPcr_int(getPcrInt());
		jsonTsUdpBO.setPat_int(getPatInt());
		jsonTsUdpBO.setPmt_int(getPmtInt());
		jsonTsUdpBO.setSdt_int(getSdtInt());
		jsonTsUdpBO.setTsid_pid(getTsidPid());
		jsonTsUdpBO.setRate_ctrl(getRateCtrl()==null?"VBR":getRateCtrl());
		if (getRateCtrl()=="VBR") {
			jsonTsUdpBO.setBitrate(getMaxBitrate()==null?8000000:getMaxBitrate()*1000);
		}else {
			jsonTsUdpBO.setBitrate(getSysRate()==null?8000000:getSysRate().intValue()*1000);
		}
		jsonTsUdpBO.setAv_mode(getAvMode());
		jsonTsUdpBO.setBuf_init(getBuf());
		...
		jsonTsUdpBO.setProgram_array(program_array);
		return jsonTsUdpBO;
	}
