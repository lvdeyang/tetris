...
public class RawSourceBO implements SourceCommon, Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -4095445948582519694L;
	private String input_id;
	private Integer program_number;
	private Integer element_pid;
	
	public RawSourceBO(String input_id, Integer program_number, Integer element_pid){
