...
public class EncodeAvsBO implements EncodeVideoCommon, Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = 7207700158699475990L;
	...
	public EncodeAvsBO(String resolution, String ratio, Integer keyint_max,
