...
public class EncodeAudioG711uBO implements EncodeAudioCommon, Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 3823869156168430528L;
	...
	public EncodeAudioG711uBO(){
		super();
	}
	public EncodeAudioG711uBO(Integer bitrate, Integer sample_rate,
