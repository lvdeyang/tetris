...
public class JsonDashBO extends JsonTsCommonBO implements OutputCommon,Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 5814642367397541517L;
	...
	public Integer getSubdir_flag() {
		return subdir_flag;
	}
	public void setSubdir_flag(Integer subdir_flag) {
		this.subdir_flag = subdir_flag;
	}
	public String getMpd_name() {
		return mpd_name;
	}
	public void setMpd_name(String mpd_name) {
