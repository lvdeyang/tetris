...
public class EncodeAudioAacBO implements EncodeAudioCommon, Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -5613819257335445195L;
	...
	public EncodeAudioAacBO(){
		super();
	}
	
	public EncodeAudioAacBO(Integer bitrate, Integer sample_rate, String sample_fmt, Integer sample_byte, String channel_layout, String type) {
		super();
