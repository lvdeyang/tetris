...
public class EncodeAudioMp3BO implements EncodeAudioCommon, Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 2828170340514709629L;
	...
	public EncodeAudioMp3BO(){
		super();
	}
	public EncodeAudioMp3BO(Integer bitrate, Integer sample_rate,
