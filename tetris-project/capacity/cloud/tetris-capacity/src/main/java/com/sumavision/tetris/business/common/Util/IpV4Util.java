...
public class IpV4Util {
    ...
    public final static int IP_D_TYPE = 4;
    public final static int IP_OTHER_TYPE = 5;
    ...
    private static int[] IpDTypeRange;
    ...
    static {
        ...
        IpATypeRange[0] = getIpV4Value("0.0.0.0");
        IpATypeRange[1] = getIpV4Value("127.255.255.255");

        IpBTypeRange = new int[2];
        IpBTypeRange[0] = getIpV4Value("128.0.0.0");
        IpBTypeRange[1] = getIpV4Value("191.255.255.255");

        IpCTypeRange = new int[2];
        IpCTypeRange[0] = getIpV4Value("192.0.0.0");
        IpCTypeRange[1] = getIpV4Value("223.255.255.255");

        IpDTypeRange = new int[2];
    ...
    public static int checkIpV4Type(String ipV4) {
        ...
        if (inValue >= IpDTypeRange[0] && inValue <= IpDTypeRange[1]) {
            return IP_D_TYPE;
        } else if (inValue >= IpCTypeRange[0] && inValue <= IpCTypeRange[1]) {
            return IP_C_TYPE;
    ...
    public static boolean ipEquals(String ip0, String ip1) {
        return getIpV4Value(ip0) == getIpV4Value(ip1);
    }
