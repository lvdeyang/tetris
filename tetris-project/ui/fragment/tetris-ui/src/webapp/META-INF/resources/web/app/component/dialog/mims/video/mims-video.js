 ...
 */
define([
    'text!' + window.APPPATH + 'component/dialog/mims/video/mims-video.html',
    'restfull',
    'vue',
    'element-ui',
    'css!' + window.APPPATH + 'component/dialog/mims/video/mims-video.css',
], function(tpl, ajax, Vue){

    var pluginName = 'mi-video-dialog';
    ...
    Vue.component(pluginName, {
        ...
        methods:{
            ...
            load:function(folderId){
                ...
                ajax.post('/media/video/feign/load', {
                    folderId:folderId
            ...
            handleOkButton:function(){
                var self = this;
                self.$emit('selected-video', self.current.previewUrl, self.__buffer, function(){
                    self.dialog.loading = true;
                }, function(){
                    self.dialog.loading = false;
                }, function(){
            ...
            videoItemClass:function(item, index){
                var c = 'video-item';
                if(item.__select){
                    c += ' select'
                }
