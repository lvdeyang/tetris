...
// For example, formatDecimal(1.23) returns ["123", 0].
    function formatDecimal(x, p) {
        if ((i = (x = p ? x.toExponential(p - 1) : x.toExponential()).indexOf("e")) < 0) return null; // NaN, ¡ÀInfinity
...
// This is almost the same as (lambda1 - lambda0 + 360¡ã) % 360¡ã, except that we want
// the distance between ¡À180¡ã to be 360¡ã.
...
// Generates a circle centered at [0¡ã, 0¡ã], with a given radius and precision.
...
// 960¡Á500. The projection also works quite well at 960¡Á600 if you change the
    ...
    function arc() {
        ...
        function arc() {
            ...
            // Or is it a circular or annular sector?
                ...
                // Apply padding? Note that since r1 ¡Ý r0, da1 ¡Ý da0.
                if (rp > epsilon$3) {
