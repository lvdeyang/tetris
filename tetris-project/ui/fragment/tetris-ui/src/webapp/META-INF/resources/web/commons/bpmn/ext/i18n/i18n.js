define(function(){
    ...
    return {
        ...
        'Append ExclusiveGateway':'附加分支节点',
        'Append UserTask':'附加用户节点',
        ...
        'Create StartEvent':'创建流程开始节点',
        'Create EndEvent':'创建流程结束节点',
        'Create UserTask':'用户节点',
        'Create ExclusiveGateway':'流程分支',
        'Create Service1 Task':'创建服务任务节点1',
        'Create Service2 Task':'创建服务任务节点2',
        /*'Task': 'Aufgabe',
