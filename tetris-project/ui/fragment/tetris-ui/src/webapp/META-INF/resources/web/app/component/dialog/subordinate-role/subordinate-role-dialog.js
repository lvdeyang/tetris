 ...
 */
define([
    'text!' + window.APPPATH + 'component/dialog/subordinate-role/subordinate-role-dialog.html',
    'restfull',
    'jquery',
    'vue',
    'element-ui',
    'css!' + window.APPPATH + 'component/dialog/subordinate-role/subordinate-role-dialog.css'
], function(tpl, ajax, $, Vue){

    var pluginName = 'mi-subordinate-role-dialog';
    ...
    Vue.component(pluginName, {
        ...
        methods:{
            ...
            handleSubordinateRoleClose:function(){
                var self = this;
                self.visible = false;
                self.rows.splice(0, self.rows.length);
                self.currentPage = 0;
            ...
            handleSubordinateRoleSelectionChange:function(val){
                var self = this;
            ...
            handleSubordinateRoleBindingOk:function(){
                var self = this;
                ...
                var close = function(){
                    self.handleSubordinateRoleClose();
                };
