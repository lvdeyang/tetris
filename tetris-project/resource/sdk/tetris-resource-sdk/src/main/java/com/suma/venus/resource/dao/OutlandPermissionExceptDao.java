...
public interface OutlandPermissionExceptDao extends CommonDao<OutlandPermissionExceptPO>{
	 ...
	 * @return List<OutlandPermissionExceptPO> 设备授权例外列表
	 */
	 ...
	 * @param SourceType sourceType 授权源类型
	 * @param Long roleId 角色id
	 * @return List<OutlandPermissionExceptPO> 文件夹授权例外列表
	 */
	public List<OutlandPermissionExceptPO> findBySerNodeNamePathAndFolderPathAndPermissionTypeAndSourceTypeAndRoleId(
			String serNodeNamePath,
			String folderPath,
			PermissionType permissionType,
			SourceType sourceType,
	 ...
	 */
	public List<OutlandPermissionExceptPO> findBySerNodeNamePathAndPermissionTypeAndRoleId(
			String serNodeNamePath,
			PermissionType permissionType,
			Long roleId);
	 ...
	 * @param Long roleId 角色id
	 * @return List<OutlandPermissionExceptPO> 文件夹授权例外情况
	 */
	public List<OutlandPermissionExceptPO> findBySerNodeNamePathAndFolderPathInAndPermissionTypeAndSourceTypeAndRoleId(
			String serNodeNamePath,
	 ...
	 * @return List<OutlandPermissionExceptPO> 文件夹勾选情况
	 */
	public List<OutlandPermissionExceptPO> findBySerNodeNamePathAndFolderPathInAndSourceTypeAndRoleIdIn(
			String serNodeNamePath,
	 ...
	 * @param SourceType sourceType 源类型
	 * @param Collection<Long> roleIds 角色id列表
	 * @return List<OutlandPermissionExceptPO> 设备勾选情况
	 */
	public List<OutlandPermissionExceptPO> findBySerNodeNamePathAndFolderPathAndDeviceIdInAndSourceTypeAndRoleIdIn(
			String serNodeNamePath,
			String folderPath,
	 ...
	 * @return List<OutlandPermissionCheckPO> 授权例外列表
	 */
	public List<OutlandPermissionExceptPO> findBySerNodeNamePathAndRoleIdIn(String serNodeNamePath, Collection<Long> roleIds);
