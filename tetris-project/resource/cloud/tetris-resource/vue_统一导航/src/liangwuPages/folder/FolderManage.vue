  ...
  <section>
    ...
    <el-card style="float:left;margin-left:50px;margin-top:10px;width:50%;min-height: 800px;" body-style="padding:0px">
      ...
      <div slot="header" class="clearfix">
        ...
        <el-button type="primary" @click="setFolder" size="small" :disabled="disableSetFolderBtn" style="float: left;">加入分组
        </el-button>
      </div>
...
import {
  addFolder, modifyFolder, deleteFolder, setFolderOfBundles, resetFolderOfBundles, initFolderTree, changeFolderIndex, getDeviceModels,
  ...
  syncFolderFromLdap, cleanupFolderLdap, changeNodePosition, resetRootNode, releaseRoot, exportFolder, exportUser
} from '../../api/api';
...
export default {
  ...
  mounted () {
    ...
    self.$nextTick(function () {
      self.$parent.$parent.$parent.$parent.$parent.setActive('/LwFolderManage');
    });
    this.initTree();
