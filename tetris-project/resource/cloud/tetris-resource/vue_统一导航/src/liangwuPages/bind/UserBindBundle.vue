<template>
  <div style="position:absolute; left:20px; top:20px; right:20px; bottom:20px;">
    <div style="width:100%; height:100%; position:relative;">
      <div style="position:absolute; left:0; top:0; bottom:0; width:400px; background-color:#fff; border-right:1px solid #EBEEF5; padding:10px; box-sizing:border-box;">
        <el-scrollbar style="height:100%;">
          <el-tree ref="userTree" :props="tree.props" :data="tree.data" node-key="uuid" check-strictly :expand-on-click-node="false" default-expand-all highlight-current @current-change="currentTreeNodeChange">
      ...
      <div v-if="tree.currentUser" style="position:absolute; left:401px; top:0; bottom:0; right:0; background-color:#fff; box-sizing:border-box; padding:10px;">
        <el-scrollbar style="height:100%;">
          ...
          <el-table :data="table.data" style="width:100%">
            <el-table-column prop="bundleName" label="设备名称">
            </el-table-column>
            <el-table-column prop="bundleId" width="300" label="bundleId">
            </el-table-column>
            <el-table-column prop="username" label="设备号码">
            </el-table-column>
    ...
    <template>
      <el-dialog title="绑定设备" :visible.sync="dialog.bindBundle.visible" width="500px" :before-close="handleBindBundleClose">
      ...
      <el-dialog title="选择编码器" :visible.sync="dialog.selectEncoder.visible" width="1000px" :before-close="handleSelectEncoderClose">
          ...
          <div style="position:absolute; left:-20px; top:-20px; right:-20px; bottom:-20px;">
            <div style="width:100%; height:100%; position:relative;">
              ...
              <div style="width:100%; position:absolute; left:0; top:40px; right:0; bottom:0; padding:0 10px; box-sizing:border-box;">
                <el-table ref="selectEncoderTable" :data="dialog.selectEncoder.table.data" height="100%" style="width:100%" highlight-current-row row-key="selectEncoderTableRowKey" @current-change="selectEncoderCurrentChange">
                  <el-table-column prop="bundleName" label="设备名称">
                  </el-table-column>
                  <el-table-column prop="bundleId" width="300" label="bundleId">
                  </el-table-column>
        ...
        <span slot="footer" class="dialog-footer">
          <el-pagination style="float:left;" background layout="total, prev, pager, next, jumper" :pageSize="dialog.selectEncoder.table.page.pageSize" :total="dialog.selectEncoder.table.page.total">
          </el-pagination>
      ...
      <el-dialog title="选择解码器" :visible.sync="dialog.selectDecoder.visible" width="1000px" :before-close="handleSelectDecoderClose">
        ...
        <div style="height:450px; position:relative;">
          <div style="position:absolute; left:-20px; top:-20px; right:-20px; bottom:-20px;">
            <div style="width:100%; height:100%; position:relative;">
              ...
              <div style="width:100%; position:absolute; left:0; top:40px; right:0; bottom:0; padding:0 10px; box-sizing:border-box;">
                <el-table ref="selectDecoderTable" :data="dialog.selectDecoder.table.data" height="100%" style="width:100%" highlight-current-row @current-change="selectDecoderCurrentChange">
                  <el-table-column prop="bundleName" label="设备名称">
                  </el-table-column>
                  <el-table-column prop="bundleId" width="300" label="bundleId">
                  </el-table-column>
        ...
        <span slot="footer" class="dialog-footer">
          <el-pagination style="float:left;" background layout="total, prev, pager, next, jumper" :pageSize="dialog.selectDecoder.table.page.pageSize" :total="dialog.selectDecoder.table.page.total">
          </el-pagination>
