<template>
    <section>
        ...
        <el-card style="float:left;margin-top:10px;width:45%;font-size: 18px; min-height: 800px;"
                 body-style="padding:0px">
            <div slot="header" class="clearfix">
                <div class="clearfix-first" style="position: relative; width: 100%; height: 37px;">
                    <el-button type="primary" size="small" @click="showAddFolderDialog" :disabled="disableAddFolderBtn"
                               style="float: left;">添加目录
                    </el-button>
                    <el-button type="primary" size="small" @click="showModifyFolderDialog"
                               :disabled="disableModifyFolderBtn" style="float: left;">修改
                    </el-button>
                    <!-- <el-button type="danger" size="small" @click="upShift" style="float: left;">测试上移</el-button> -->
                    <el-button type="danger" size="small" @click="deleteFolder" :disabled="disableDeleteFolderBtn"
                               style="float: left;">删除
                    </el-button>
                ...
                <div class="clearfix-second" style="position: relative;">
                    ...
                    <el-button type="primary" size="small" @click="exportFolder"
                               style="float: left; margin-left: 10px;">导出分组
                    </el-button>
        ...
        <el-card style="float:left;margin-left:50px;margin-top:10px;width:50%;min-height: 800px;"
                 body-style="padding:0px">

            <div slot="header" class="clearfix">
                <el-select v-model="filters.deviceModel" size="small" placeholder="选择设备类型"
                           style="float: left;margin-left: 30px;width:100px;">
                    <el-option v-for="item in deviceModelOptions" :key="item.value" :label="item.label"
                               :value="item.value">
                    </el-option>
                </el-select>
                <el-input v-model="filters.keyword" size="small" style="float: left;margin-left: 30px;width:150px;"
                ...
                <el-button type="primary" @click="setFolder" size="small" :disabled="disableSetFolderBtn"
                           style="float: right;margin-right: 50px;">加入分组
                </el-button>
            </div>

            <!--设备列表-->
            <el-table :data="resources" v-show="resourceTableShow" v-loading="resourceTableLoading"
            ...
            <!--用户列表-->
            <el-table :data="users" v-show="userTableShow" v-loading="userTableLoading"
                      @selection-change="handleSelectionChange" style="width: 100%;">
                <el-table-column width="50" type="selection"></el-table-column>
            ...
            <el-form :model="folderForm" label-width="100px">
                ...
                <el-form-item label="上传LDAP">
                    <el-select v-model="folderForm.toLdap" placeholder="是否上传LDAP">
                        <el-option v-for="item in toLdapoptions" :key="item.value" :label="item.label"
                                   :value="item.value">
                        </el-option>
                    </el-select>
                </el-form-item>
