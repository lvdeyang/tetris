require.config({
    ...
    paths: {
        ...
        'jquery-qrcode':window.BASEPATH + 'web/jQuery-qrcode/jquery.qrcode.min',
        ...
        /* page */
        'page-patrol-address-management':window.APPPATH + 'patrol/address-management/page-patrol-address-management',
        'page-patrol-sign-info':window.APPPATH + 'patrol/sign-info/page-patrol-sign-info'
